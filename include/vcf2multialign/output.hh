...
namespace vcf2multialign {
	...
	public:
		output(char const *pipe_cmd, bool const should_output_reference, bool const should_output_unaligned, output_delegate &delegate):
			m_pipe_cmd(pipe_cmd),
			m_delegate(&delegate),
	...
	public:
		founder_sequence_greedy_output(char const *pipe_cmd, bool const should_output_reference, bool const should_keep_ref_edges, bool const should_output_unaligned, output_delegate &delegate):
			output(pipe_cmd, should_output_reference, should_output_unaligned, delegate),
